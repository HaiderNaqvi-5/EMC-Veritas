...
from app.api.admin.executive_memberships import router as admin_executive_memberships_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(admin_executive_memberships_router, prefix=f"{settings.api_prefix}/admin")
