...
def issue_activity_documents(
    ...
    # ⚡ Bolt Optimization: Fetch Student objects via JOIN upfront (O(1) query)
    # instead of doing N+1 lookups (db.get) inside the issuance loop.
    # Impact: Reduces database queries by N when issuing certificates to N students.
